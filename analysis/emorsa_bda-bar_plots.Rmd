...
### bar plot
emoIsComm manipulation
```{r fig20, fig.height=5, fig.width=10, warning=FALSE}
plot_state_emoIsComm + plot_df_state_emoIsComm
```
goal manipulation
```{r fig21, fig.height=5, fig.width=10, warning=FALSE}
plot_state_goal + plot_df_state_goal
```
state manipulation
```{r fig22, fig.height=5, fig.width=10, warning=FALSE}
plot_state_state + plot_df_state_state
```
...
#   facet_wrap(vars(manipulation, manipulation_level), nrow = 3)+
...
### bar plot
emoIsComm manipulation
```{r fig23, fig.height=5, fig.width=10, warning=FALSE}
plot_inf_emoIsComm + plot_df_inf_emoIsComm
```
goal manipulation
```{r fig24, fig.height=5, fig.width=10, warning=FALSE}
plot_inf_goal + plot_df_inf_goal
```
state manipulation
```{r fig25, fig.height=5, fig.width=10, warning=FALSE}
plot_inf_state + plot_df_inf_state
```
...
### bar plot
emoIsComm manipulation
```{r fig26, fig.height=5, fig.width=10, warning=FALSE}
plot_soc_emoIsComm + plot_df_soc_emoIsComm
```
goal manipulation
```{r fig27, fig.height=5, fig.width=10, warning=FALSE}
plot_soc_goal + plot_df_soc_goal
```
state manipulation
```{r fig28, fig.height=5, fig.width=10, warning=FALSE}
plot_soc_state + plot_df_soc_state
```
